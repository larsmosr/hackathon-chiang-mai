---
name: Voice to Content MVP
overview: Transform the existing SaaS boilerplate into a voice-to-content app for indie makers. The plan covers data model redesign, voice recording integration, AI post generation, and platform-specific UI flows.
todos:
  - id: phase-0
    content: "Cleanup: Remove layouts/, messages, test tables, update landing page"
    status: pending
  - id: phase-1
    content: "Schema: Add voiceEntries, generatedPosts, styleProfiles + CRUD functions"
    status: pending
  - id: phase-2
    content: "Recording UI: RecordButton, useVoiceRecorder hook, entry list/cards"
    status: pending
  - id: phase-3
    content: "STT: ElevenLabs integration, HTTP endpoint, audio storage"
    status: pending
  - id: phase-4
    content: "Agents: Chirp/Lindy/Pixel/Skylar characters, prompts, generation + chat"
    status: pending
  - id: phase-5
    content: "Context: History injection, style profile inference, settings page"
    status: pending
  - id: phase-6
    content: "Agent UI: Selector, chat refinement, tabs, copy button, detail page"
    status: pending
  - id: phase-7
    content: "Polish: Skeletons, errors, mobile, shortcuts, onboarding, animations"
    status: pending
---
